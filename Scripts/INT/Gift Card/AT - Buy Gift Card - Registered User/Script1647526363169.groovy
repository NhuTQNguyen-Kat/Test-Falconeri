...
WebUI.callTestCase(findTestCase('INT/User Registration/AT - User Registration'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/at/damen/')
...
WebUI.enhancedClick(findTestObject('FLC/Universal/logInAccount'))
