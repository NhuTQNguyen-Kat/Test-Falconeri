...
WebUI.callTestCase(findTestCase('INT/User Registration/US - User Registration'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/us/women/')

WebUI.enhancedClick(findTestObject('INT/Universal/saveLang'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/us/buygiftcard/?type=W&pid=EGC0001%20%20IT%20%2050_EUR')
...
WebUI.enhancedClick(findTestObject('Object Repository/INT/IT/Page_Pagamento - Intimissimi/button_Procedi'), FailureHandling.OPTIONAL)

WebUI.enhancedClick(findTestObject('INT/US/SelectPPUS'))

WebUI.enhancedClick(findTestObject('INT/US/GibSoulUS'))

WebUI.enhancedClick(findTestObject('INT/US/PaywithPP'))
