...
WebUI.callTestCase(findTestCase('INT/User Registration/FR - User Registration'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/it/donna/')
...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/it/buygiftcard/?type=W&pid=EGC0001%20%20IT%20%2050_EUR')
...
WebUI.enhancedClick(findTestObject('INT/Universal/toCart'))
...
WebUI.enhancedClick(findTestObject('INT/IT/Page_Accedi al tuo conto PayPal/sellSoulPPIt'))

WebUI.enhancedClick(findTestObject('INT/Universal/classPP'))
