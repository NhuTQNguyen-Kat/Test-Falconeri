...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/es/mujer/')
...
WebUI.click(findTestObject('Object Repository/INT/DE/Page_Damenunterwsche Alle Produkte entdecke_54ef66/button_Einloggen'))

WebUI.click(findTestObject('Object Repository/INT/DE/Page_Damenunterwsche Alle Produkte entdecke_54ef66/svg__no-margin'))

WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/fr/buygiftcard/?type=W&pid=EGC0001%20%20IT%20%2050_EUR')
...
WebUI.click(findTestObject('INT/Universal/toCart'))
