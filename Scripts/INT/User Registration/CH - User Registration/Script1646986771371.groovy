...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/ch/damen/')

WebUI.enhancedClick(findTestObject('INT/CH/Page_Damenunterwsche von Intimissimi BHs, Lingerie, Slips/saveLanguageCH'))
