...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/pl/kobieta/')

WebUI.enhancedClick(findTestObject('INT/PL/Page_Bielizna damska biustonosze, figi, bielizna  Intimissimi/svg__no-margin'))
