...
WebUI.navigateToUrl('https://storefront:may2019@test.intimissimi.com/us/product/modal_ultralight_cashmere_blend_top_with_lace-LTD28Q.html?dwvar_LTD28Q_Z_COL_INTD=231I&bigcup=true')

WebUI.click(findTestObject('Object Repository/INT/US/Page_Modal Ultralight Cashmere Blend Top wi_64639b/button_Save'))
...
WebUI.click(findTestObject('INT/US/removeSKU'))
