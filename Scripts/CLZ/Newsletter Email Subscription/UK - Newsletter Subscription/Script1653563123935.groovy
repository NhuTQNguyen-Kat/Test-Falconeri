...
WebUI.authenticate('https://test.calzedonia.com/uk/', 'storefront', 'may2019', 0)
...
WebUI.setText(findTestObject('CLZ/Page_Shop Womans Legwear and Beachwear on Calzedonia/ovdjeidemailCLZuk'), 'ovdjeidemail@yopmail.com')

WebUI.enhancedClick(findTestObject('CLZ/Page_Shop Womans Legwear and Beachwear on Calzedonia/klikitiKlikzamail'))
