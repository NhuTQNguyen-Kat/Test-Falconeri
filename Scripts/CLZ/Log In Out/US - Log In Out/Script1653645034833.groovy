...
WebUI.navigateToUrl('https://storefront:may2019@test.calzedonia.com/us/')

WebUI.enhancedClick(findTestObject('CLZ/saveLangCLT'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Object Repository/CLZ/Page_Calzedonia - Calze, Collant, Leggings _aa9d2e/span_'))
