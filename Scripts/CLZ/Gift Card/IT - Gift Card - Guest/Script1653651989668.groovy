...
WebUI.navigateToUrl('https://storefront:may2019@test.calzedonia.com/it/')
...
WebUI.click(findTestObject('Object Repository/CLZ/Page_Electronic Giftcard - calzedonia_ww - _409864/svg_Iscriviti ora_minicart-link-svg'))
...
WebUI.click(findTestObject('Object Repository/CLZ/Page_Pagamento - Calzedonia/span_Conferma e invia ordine_radio-input'))
...
String result = WebUI.getText(findTestObject('Object Repository/CLZ/Page_Ordine Completato - Calzedonia/h2_Grazie per il tuo ordine 21052606')).replaceAll('[^0-9]', '')
