...
WebUI.navigateToUrl('https://storefront:may2019@test.calzedonia.com/pl/')
...
WebUI.click(findTestObject('CLZ/US/clzSelectPPUS'))

WebUI.click(findTestObject('CLZ/PL/acceptBlik'))

WebUI.click(findTestObject('CLZ/PL/registeredPayWithBlik'))

WebUI.click(findTestObject('CLZ/PL/mTRANSFER'))

WebUI.click(findTestObject('CLZ/PL/ZAPLACI'))

String result = WebUI.getText(findTestObject('Object Repository/CLZ/registeredThankYou')).replaceAll('[^0-9]', '')
