...
WebUI.navigateToUrl('https://storefront:may2019@test.calzedonia.com/pt/product/leggings_active-MIP031.html?dwvar_MIP031_Z_COL_COLLD=019')
...
WebUI.click(findTestObject('FLC/PT/removeFromCartQuestion'))

WebUI.click(findTestObject('FLC/PT/removeFromCartConfirm'))

WebUI.click(findTestObject('FLC/PT/editSKU'))
