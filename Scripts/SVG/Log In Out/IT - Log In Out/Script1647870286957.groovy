...
WebUI.enhancedClick(findTestObject('SVG/Universal/smallNewsletterX'))
...
WebUI.enhancedClick(findTestObject('SVG/Universal/passwordSaveSlider'))

WebUI.enhancedClick(findTestObject('SVG/Universal/logIn'))

WebUI.enhancedClick(findTestObject('SVG/Universal/userAccount'))
