...
WebUI.navigateToUrl('https://storefront:may2019@test.falconeri.com/us/women/')

WebUI.enhancedClick(findTestObject('FLC/US/Page_Visita/button_Save'))

WebUI.enhancedClick(findTestObject('Object Repository/FLC/IT/Page_Visita il sito ufficiale Falconeri Mag_6f50cd/span_Accedi'))

WebUI.enhancedClick(findTestObject('Object Repository/FLC/IT/Page_Visita il sito ufficiale Falconeri Mag_6f50cd/a_Registrati'))
...
CustomKeywords.'testingWritingRadnomVariables_K.WriteRadnomMailandNumber.writeRadnomData'(GlobalVariable.locale, GlobalVariable.randomSurname, GlobalVariable.randomMail, brand, timeDate)
