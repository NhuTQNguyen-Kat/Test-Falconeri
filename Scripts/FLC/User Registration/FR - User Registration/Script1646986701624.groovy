...
WebUI.navigateToUrl('https://storefront:may2019@test.falconeri.com/fr/femme/')
...
checker = WebUI.verifyElementPresent(findTestObject('Object Repository/FLC/IT/Page_Inbox/a_ATTIVA ACCOUNT'), 10, FailureHandling.OPTIONAL)
