...
WebUI.navigateToUrl('https://storefront:may2019@test.falconeri.com/at/')

WebUI.enhancedClick(findTestObject('FLC/Universal/newsletterX'))
...
WebUI.enhancedClick(findTestObject('FLC/Universal/rememberPasswordSlider'), FailureHandling.STOP_ON_FAILURE)
