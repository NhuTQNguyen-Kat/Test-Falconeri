...
WebUI.navigateToUrl('https://storefront:may2019@test.falconeri.com/pt/')

WebUI.enhancedClick(findTestObject('FLC/Universal/newsletterX'), FailureHandling.OPTIONAL)
