...
WebUI.authenticate('https://test.falconeri.com/ch/damen/', 'storefront', 'may2019', 0)
...
WebUI.enhancedClick(findTestObject('FLC/CH/selectPPCH'))

WebUI.enhancedClick(findTestObject('FLC/CH/agreePPCH'))

WebUI.enhancedClick(findTestObject('FLC/CH/payPPCH'))
