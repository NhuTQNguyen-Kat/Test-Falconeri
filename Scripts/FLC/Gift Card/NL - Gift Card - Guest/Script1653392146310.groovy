...
WebUI.authenticate('https://test.falconeri.com/nl/women/', 'storefront', 'may2019', 0)

WebUI.scrollToElement(findTestObject('FLC/NL/GCIconNL'), 0)

WebUI.enhancedClick(findTestObject('FLC/NL/GCIconNL'))
