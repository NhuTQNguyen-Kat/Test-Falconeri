...
WebUI.authenticate('https://test.falconeri.com/uk/women/', 'storefront', 'may2019', 0)

WebUI.scrollToElement(findTestObject('FLC/UK/GCIconUK'), 0)

WebUI.enhancedClick(findTestObject('FLC/UK/GCIconUK'))
