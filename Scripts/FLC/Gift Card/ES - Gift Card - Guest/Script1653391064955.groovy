...
WebUI.authenticate('https://test.falconeri.com/es/mujer/', 'storefront', 'may2019', 0)
...
WebUI.enhancedClick(findTestObject('FLC/ES/selectPPes'))

WebUI.enhancedClick(findTestObject('FLC/ES/agreePPes'))

WebUI.enhancedClick(findTestObject('FLC/ES/payPPes'))
