...
WebUI.waitForElementPresent(findTestObject('Object Repository/FLC/DE/thankYouRegistered'), 
    0)

WebUI.delay(5)

String result = WebUI.getText(findTestObject('Object Repository/FLC/DE/thankYouRegistered')).replaceAll(
    '[^0-9]', '')
