...
WebUI.authenticate('https://storefront:may2019@test.falconeri.com/pt/senhora', 'storefront', 'may2019', 0, FailureHandling.OPTIONAL)
...
WebUI.enhancedClick(findTestObject('INT/Universal/PP/selectPPasPayment'))

WebUI.enhancedClick(findTestObject('INT/Universal/PP/sellPPsoul'))

WebUI.enhancedClick(findTestObject('INT/Universal/PP/payPP'))
