...
int RN = ((Math.random() * 100000000 //This gives a random number between 0 and 10000
    ) as int)
...
WebUI.authenticate('https://test.falconeri.com/us/women/', 'storefront', 'may2019', 0)

WebUI.click(findTestObject('FLC/Universal/saveLanguageMay'))

WebUI.scrollToElement(findTestObject('FLC/CH/GCIconCH'), 0)

WebUI.enhancedClick(findTestObject('FLC/CH/GCIconCH'))
...
WebUI.enhancedClick(findTestObject('FLC/US/continueToPaymentUS'))
...
WebUI.enhancedClick(findTestObject('FLC/US/selectPPus'))

WebUI.enhancedClick(findTestObject('FLC/US/agreePPus'))

WebUI.enhancedClick(findTestObject('FLC/US/payPPus'))
