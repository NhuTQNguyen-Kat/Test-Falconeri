...
WebUI.navigateToUrl('https://storefront:may2019@test.falconeri.com/us/product/jacke_aus_cashmere_ultralight-DML261G.html?dwvar_DML261G_Z_COL_FALCD=9107')
...
WebUI.click(findTestObject('FLC/US/removeFromCart'))

WebUI.click(findTestObject('FLC/US/confirmRemoveFromCartUS'))
